...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " afgn-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  afgn-tx [options] <hex-tx> [commands]  Update hex-encoded afgn transaction\n" +
            "or:     afgn-tx [options] -create [commands]   Create hex-encoded afgn transaction\n" +
            "\n";
