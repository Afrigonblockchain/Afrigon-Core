...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(3000000024999990LL).write() == "40000000.24999990");
    BOOST_CHECK(ValueFromAmount(3000000024999999LL).write() == "40000000.24999999");
    BOOST_CHECK(ValueFromAmount(3000000025000000LL).write() == "40000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("40000000.2499999")), 3000000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("40000000.24999999")), 3000000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("40000000.25")), 3000000025000000LL);
