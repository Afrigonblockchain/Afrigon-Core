...
////////////////////////////////////////////////////////////// afgn
    ...
    boost::filesystem::path pathTemp = fs::temp_directory_path() / strprintf("test_afgn_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    boost::filesystem::create_directories(pathTemp);
    const dev::h256 hashDB(dev::sha3(dev::rlp("")));
    globalState = std::unique_ptr<AfgnState>(new AfgnState(dev::u256(0), AfgnState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
