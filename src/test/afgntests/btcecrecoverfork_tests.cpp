...
//    initState();
    ...
    std::vector<AfgnTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createAfgnTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAfgnTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAfgnTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAfgnTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
