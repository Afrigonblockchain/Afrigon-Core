...
#include "genesis/afgnMainNetwork.cpp"
...
#include "genesis/test/afgnTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::afgnMainNetwork: return c_genesisInfoAfgnMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::afgnTestNetwork: return c_genesisInfoAfgnTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::afgnMainNetwork: return c_genesisStateRootAfgnMainNetwork;
    case Network::afgnTestNetwork: return c_genesisStateRootAfgnTestNetwork;
