...
////////////////////////////////////////////////////////////// // afgn
    void setAfgnSchedule(EVMSchedule _afgnSchedule) const { afgnSchedule = _afgnSchedule; }

    EVMSchedule& getAfgnSchedule() const { return afgnSchedule; }
...
private:
    ...
    mutable EVMSchedule afgnSchedule; // afgn
