#ifndef AFGNVERSIONCHECKER_H
#define AFGNVERSIONCHECKER_H

#include <QObject>

#define AFGN_RELEASES "https://github.com/afrigonblockchain/afrigon-core/releases"
...
class AfgnVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit AfgnVersionChecker(QObject *parent = 0);
    ~AfgnVersionChecker();
