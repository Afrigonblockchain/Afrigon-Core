...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AFGN");
    case mBTC: return QString("mAFGN");
    case uBTC: return QString::fromUtf8("μAFGN (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Afgns");
    case mBTC: return QString("Milli-Afgns (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Afgns (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
