...
public:
    ...
    void setAfgnTokenExec(AfgnTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strAfgnAddress, std::string& strHash160);
    static bool ToAfgnAddress(const std::string& strHash160, std::string& strAfgnAddress);
...
private:
    ...
    AfgnToken(AfgnToken const&);
    AfgnToken& operator=(AfgnToken const&);
