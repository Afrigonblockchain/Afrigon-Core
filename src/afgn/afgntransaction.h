#ifndef AFGNTRANSACTION_H
#define AFGNTRANSACTION_H
...
class AfgnTransaction : public dev::eth::Transaction{

public:

    AfgnTransaction() : nVout(0), hasRefundSender(false) {}

    AfgnTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
        dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) , nVout(0), hasRefundSender(false) {}

    AfgnTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
