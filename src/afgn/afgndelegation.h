#ifndef AFGNDELEGATION_H
#define AFGNDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IAfgnStaker class Delegation filter
 */
...
/**
 * @brief The AfgnDelegation class Communicate with the afgn delegation contract
 */
class AfgnDelegation {
    
public:
    /**
     * @brief AfgnDelegation Constructor
     */
    AfgnDelegation();

    /**
     * @brief ~AfgnDelegation Destructor
     */
    virtual ~AfgnDelegation();
...
private:
    AfgnDelegation(const AfgnDelegation&);
    AfgnDelegation& operator=(const AfgnDelegation&);
    AfgnDelegationPriv* priv;
};
#endif
