...
from test_framework.afgn import convert_btc_bech32_address_to_afgn, generatesynchronized
...
class P2PPermissionsTests(BitcoinTestFramework):
    ...
    def check_tx_relay(self):
        block_op_true = self.nodes[0].getblock(generatesynchronized(self.nodes[0], COINBASE_MATURITY+1, convert_btc_bech32_address_to_afgn(ADDRESS_BCRT1_P2WSH_OP_TRUE), self.nodes)[0])
        self.sync_all()
        ...
        tx = FromHex(
            ...
            self.nodes[0].createrawtransaction(
                inputs=[{
                    ...
                    convert_btc_bech32_address_to_afgn(ADDRESS_BCRT1_P2WSH_OP_TRUE): 5,
                }]),
        )
