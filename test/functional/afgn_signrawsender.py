...
class AfgnSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some afgn to both addresses (one contract will increase its balance and the other one will throw),
