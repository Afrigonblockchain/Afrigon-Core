...
from test_framework.afgnconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        not_related_address = convert_btc_address_to_afgn("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")
