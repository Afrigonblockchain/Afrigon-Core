...
from test_framework.afgnconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class AfgnRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    AfgnRPCSearchlogsTestModified().main()